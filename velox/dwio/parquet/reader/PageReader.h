...
class PageReader {
 ...
 private:
  ...
  // Base values of dictionary when reading a non-string dictionary.
  // Cached to avoid creating a new FlatVector wrapper every batch.
  VectorPtr typedDictionaryValues_;
